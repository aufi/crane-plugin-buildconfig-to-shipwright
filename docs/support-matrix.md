...
- W52 and W30 end with ` If another BuildConfig in namespace … builds that image, run its BuildRun to completion before starting this Build; Shipwright does not order BuildRuns.`
